import{d as n,ae as o,j as t}from"./vendor-B3RbiV3q.js";import{X as l}from"./icons-CLK6f0m_.js";function d({title:i="Thông báo",message:r,onClose:a,duration:s=3500}){return n.useEffect(()=>{if(!r)return;const e=setTimeout(a,s);return()=>clearTimeout(e)},[r,a,s]),r?o.createPortal(t.jsxs("div",{className:`
