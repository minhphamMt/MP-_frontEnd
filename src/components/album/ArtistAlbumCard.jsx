...
export default function ArtistAlbumCard({ artist }) {
  ...
  return (
    <div
      ...
      hover:shadow-[0_30px_80px_rgba(56,189,248,0.25)] sm:w-60 sm:p-4 lg:w-64"
    >
      {/* glow nền */}
      ...
      {/* AVATAR */}
       <div className="relative mx-auto w-24 overflow-hidden rounded-full sm:w-36 lg:w-44">
        <img
      ...
      {/* INFO */}
       <div className="relative mt-3 space-y-1 text-center sm:mt-4">
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-white/70 sm:text-sm">
