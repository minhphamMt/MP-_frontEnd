import{d as n,ae as o,j as t}from"./vendor-DAr68pOg.js";import{X as l}from"./icons-EkTL-9ZC.js";function d({title:i="Thông báo",message:r,onClose:a,duration:s=3500}){return n.useEffect(()=>{if(!r)return;const e=setTimeout(a,s);return()=>clearTimeout(e)},[r,a,s]),r?o.createPortal(t.jsxs("div",{className:`
