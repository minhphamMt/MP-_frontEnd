import{d as n,ae as o,j as t}from"./vendor-Byu-RvLo.js";import{j as l}from"./icons-BSlfitJi.js";function d({title:i="Thông báo",message:r,onClose:a,duration:s=3500}){return n.useEffect(()=>{if(!r)return;const e=setTimeout(a,s);return()=>clearTimeout(e)},[r,a,s]),r?o.createPortal(t.jsxs("div",{className:`
